...
namespace FormApi.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SubmissionAction :  IEquatable<SubmissionAction>, IValidatableObject
    {
        /// <summary>
        /// Defines State
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SubmissionAction" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SubmissionAction() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SubmissionAction" /> class.
        /// </summary>
        ...
        public SubmissionAction(string id = default(string), string integrationId = default(string), StateEnum state = default(StateEnum), ActionCategoryEnum actionCategory = default(ActionCategoryEnum), ActionTypeEnum actionType = default(ActionTypeEnum), Object resultData = default(Object))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for SubmissionAction and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            {
                throw new InvalidDataException("integrationId is a required property for SubmissionAction and cannot be null");
            }
            else
            {
            ...
            if (state == null)
            {
                throw new InvalidDataException("state is a required property for SubmissionAction and cannot be null");
            }
            else
            {
                this.State = state;
            ...
            {
                throw new InvalidDataException("actionCategory is a required property for SubmissionAction and cannot be null");
            }
            else
            {
            ...
            if (actionType == null)
            {
                throw new InvalidDataException("actionType is a required property for SubmissionAction and cannot be null");
            }
            else
            {
            ...
            if (resultData == null)
            {
                throw new InvalidDataException("resultData is a required property for SubmissionAction and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as SubmissionAction);
        }

        /// <summary>
        /// Returns true if SubmissionAction instances are equal
        /// </summary>
        /// <param name="input">Instance of SubmissionAction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubmissionAction input)
        {
            if (input == null)
                return false;
