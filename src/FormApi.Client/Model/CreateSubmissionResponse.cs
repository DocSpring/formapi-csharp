...
namespace FormApi.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateSubmissionResponse :  IEquatable<CreateSubmissionResponse>, IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        {
            return this.Equals(input as CreateSubmissionResponse);
        }

        /// <summary>
        /// Returns true if CreateSubmissionResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateSubmissionResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateSubmissionResponse input)
        {
            if (input == null)
                return false;
