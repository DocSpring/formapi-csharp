...
namespace FormApi.Client.Model
{
    ...
    public partial class UpdateSubmissionDataRequestData :  IEquatable<UpdateSubmissionDataRequestData>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as UpdateSubmissionDataRequestData);
        }

        /// <summary>
        /// Returns true if UpdateSubmissionDataRequestData instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateSubmissionDataRequestData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateSubmissionDataRequestData input)
        {
            if (input == null)
                return false;
