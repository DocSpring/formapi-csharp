...
namespace FormApi.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MoveFolderData :  IEquatable<MoveFolderData>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as MoveFolderData);
        }

        /// <summary>
        /// Returns true if MoveFolderData instances are equal
        /// </summary>
        /// <param name="input">Instance of MoveFolderData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MoveFolderData input)
        {
            if (input == null)
                return false;
