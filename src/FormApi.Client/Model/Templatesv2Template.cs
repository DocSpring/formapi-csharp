...
namespace FormApi.Client.Model
{
    ...
    public partial class Templatesv2Template :  IEquatable<Templatesv2Template>, IValidatableObject
    {
        ...
        public Templatesv2Template(ExpirationIntervalEnum? expirationInterval = default(ExpirationIntervalEnum?), bool? publicWebForm = default(bool?), string webhookUrl = default(string), bool? expireSubmissions = default(bool?), decimal? expireAfter = default(decimal?), bool? allowAdditionalProperties = default(bool?), Templatesv2TemplateDocument document = default(Templatesv2TemplateDocument), string name = default(string), bool? publicSubmissions = default(bool?), string slackWebhookUrl = default(string), string redirectUrl = default(string), bool? blockchainTimestampVerification = default(bool?))
        {
